      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
        <Container className="d-flex justify-content-between align-items-center">
          ...
          <div className="collapse navbar-collapse d-flex justify-content-end">
            <ul className="navbar-nav d-flex align-items-center">
              <li className="nav-item">
                <Button variant="danger" onClick={handleCancel}>Volver a Perfil</Button>
              </li>
            </ul>
          </div>
        </Container>
      </nav>
      <div className="background-senderismo">
        <Container className="py-5">
          <Row className="justify-content-center">
            <Col md={8} lg={6}>
              <Card className="p-4 bg-light shadow-sm card-container">
                <Card.Body>
                  <h2 className="text-center mb-4">Editar Perfil</h2>
                  {showMessage && (
                    <Alert variant={messageType} onClose={() => setShowMessage(false)} dismissible>
